...
assembly_example4='''
        ...
        Python Code=
            ...
            # Initiating the calculation for n = 5
            result = calculate_factorial(5)

            # Preparing to exit the program (similar to storing the result in EBX)
            final_result = result

            # Exiting the program (similar to making a syscall for sys_exit)
            import sys
            sys.exit(0)
'''
